...
module.exports = {
    ...
    aesEncrypt(data) {
        ...
        const crypto = CryptoJS.AES.encrypt(str, CryptoJS.enc.Utf8.parse(_default.key), {
            iv: CryptoJS.enc.Utf8.parse(_default.iv),
    ...
    aesDecrypt(data) {
        const decrypt = CryptoJS.AES.decrypt(data, CryptoJS.enc.Utf8.parse(_default.key), {
            iv: CryptoJS.enc.Utf8.parse(_default.iv),
            mode: CryptoJS.mode.ECB,
            padding: CryptoJS.pad.Pkcs7,
        });
    ...
    decrypt(str) {
        ...
        decrypted.setPrivateKey(privateKey.toString()); // 设置私钥
